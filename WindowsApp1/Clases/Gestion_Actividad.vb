...
Public Class Gestion_Actividad
    ...
    '    conexion.Open()
    '    Dim sql As String = $"INSERT INTO ACTIVIDADES VALUES ({actividad.Nombre}, {actividad.Duracion}, {actividad.FechaInicio}, {actividad.FechaFin}, {actividad.NumMaxVol}, {actividad.Organizacion}, {actividad.Descripcion})"
