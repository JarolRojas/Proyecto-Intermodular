...
Public Class Voluntario
    ...
    Public Sub New(nombre As String, apellido1 As String, apellido2 As String, correo As String, telefono As String, fechaNacimiento As Date, descripcion As String, codCiclo As String, ciclo As Ciclo, disponibilidades As List(Of Disponibilidad), actividades As List(Of Actividad), tiposActividadPreferidos As List(Of Tipo_Actividad))
        Me.Nombre = nombre
